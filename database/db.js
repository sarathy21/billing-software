...
const defaultGodowns = ['Godown 1', 'Godown 2', 'Godown 3'];
const insertGodownStmt = db.prepare(`INSERT OR IGNORE INTO godowns (name) VALUES (?)`);
defaultGodowns.forEach((name) => insertGodownStmt.run(name));
